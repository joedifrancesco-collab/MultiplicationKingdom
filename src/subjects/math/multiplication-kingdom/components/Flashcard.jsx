    ...
    return (
      <div className="flashcard-done">
        ...
        <div className="done-buttons">
          <button onClick={() => navigate(`/subjects/math/multiplication-kingdom/${id}`)}>Back to Kingdom</button>
  ...
  return (
    <div className="flashcard-container">
      <div className="flashcard-header">
        <button className="back-btn" onClick={() => navigate(`/subjects/math/multiplication-kingdom/${id}`)}>‹</button>
