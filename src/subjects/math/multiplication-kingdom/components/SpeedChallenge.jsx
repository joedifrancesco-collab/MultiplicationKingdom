    ...
    return (
      <div className="speed-done">
        ...
        <div className="done-buttons">
          <button onClick={() => navigate('/subjects/math/multiplication-kingdom')}>Back to Kingdom Map</button>
  ...
  return (
    <div className="speed-container">
      <div className="speed-topbar">
        <button className="speed-quit-btn" onClick={() => navigate('/subjects/math/multiplication-kingdom')}>✕ Quit</button>
