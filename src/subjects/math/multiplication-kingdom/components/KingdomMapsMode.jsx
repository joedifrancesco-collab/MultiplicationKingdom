    ...
    <div className="kmm-container">
      ...
      <div className="kmm-modes">
        <button
          ...
          onClick={() => navigate('/subjects/math/multiplication-kingdom/maps/freePlay')}
        >
        ...
        <button
          ...
          onClick={() => navigate('/subjects/math/multiplication-kingdom/maps/timed')}
        >
        ...
        <button
          ...
          onClick={() => navigate('/subjects/math/multiplication-kingdom/maps/rowColumn')}
        >
          <div className="kmm-mode-icon">📊</div>
          <div className="kmm-mode-body">
